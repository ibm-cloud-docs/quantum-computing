...
* *Project*: A grouping unit that enables users to work on the same resources. This tutorial uses two projects; `ml` and `finance`. See [Nested project structures](#nest-org) for more information.
